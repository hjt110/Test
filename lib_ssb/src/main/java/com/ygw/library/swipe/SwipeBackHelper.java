...
public class SwipeBackHelper {
    ...
    private void initSwipeBackFinish() {
        if (mDelegate.isSupportSwipeBack()) {
            mSwipeBackLayout = mActivity.findViewById(R.id.swipe_layout);
            mSwipeBackLayout.addShadow(mActivity);
    ...
    public static void executeForwardAnim(Activity activity) {
        activity.overridePendingTransition(R.anim.bga_swipe_activity_forward_enter, R.anim.bga_swipe_activity_forward_exit);
    }
    ...
    public static void executeBackwardAnim(Activity activity) {
        activity.overridePendingTransition(R.anim.bga_swipe_activity_backward_enter, R.anim.bga_swipe_activity_backward_exit);
    }
